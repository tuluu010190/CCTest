...
public class instantBrowser {
	...
	public static String getGeckoDriver() {
		String path = System.getProperty("user.dir") + File.separator + FOLDER_DRIVER + File.separator + "geckodriver.exe";
		System.out.println("path is: " + path);
		try {
			File driverChrome = new File(path);
			if (driverChrome.exists()) {
	...
	public static WebDriver initiateDriver() {
		...
		if (browser.equalsIgnoreCase("firefox")) {
			try {
				driver = null;
				System.setProperty("webdriver.gecko.driver", instantBrowser.getGeckoDriver());
